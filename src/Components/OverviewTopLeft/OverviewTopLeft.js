...
export default function OverviewTopLeft() {
	return (
		<div className='overview-top__left-account'>
			<svg
				className='overview-top__lupe'
				width='16'
				height='16'
				viewBox='0 0 16 16'
				fill='none'
			...
			<span className='overview-top__line'></span>
			<strong className='overview-top__name'>Jones Ferdinand</strong>
			<img src={Account} alt='' />
		</div>
	);
}
